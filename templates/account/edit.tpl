      ...
      <div class="<!-- IF !sso.length -->col-md-9 col-sm-8<!-- ELSE -->col-md-5 col-sm-4<!-- ENDIF !sso.length -->">
        <div>
          <form class='form-horizontal'>
            ...
            <div class="control-group">
              <label class="control-label" for="inputAboutMe">[[user:aboutme]]</label>
              <small><label id="aboutMeCharCountLeft"></label></small>
              <div class="controls">
            ...
            <div class="control-group">
              ...
              <small><label id="signatureCharCountLeft"></label></small>
              <div class="controls">
